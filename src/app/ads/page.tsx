...
const Ads = () => {
  return (
    <div className='mobile:px-[30px] mobile:mt-[140px] md:mt-[170px] mb-[100px] md:px-[124px]'>
        <div className='flex mobile:flex-col-reverse md:flex-row justify-between mobile:gap-[34px] md:gap-0'>
            <div className='mobile:w-full md:w-[600px] text-[#05264E]'>
                ...
                <div className='mt-[2.1rem] flex mobile:flex-col md:flex-row md:items-center gap-[20px] mobile:w-[300px] md:w-full'>
                    <button
        ...
        <h2 className='mobile:text-[25px] md:text-4xl font-bold text-[#05264E] mt-[4.5rem]'>Benefits of using spotlight posts to reach your work goal</h2>

        <div className='mt-[4.5rem] mobile:block md:flex justify-between'>
            <div className="card mobile:w-full md:w-[380px] mobile:mb-[55px] md:mb-0 ">
        ...
        <div>
            <h2 className='mobile:text-[25px] md:text-4xl font-bold text-[#05264E] mt-[4.5rem]'>Why do I need to use ads?</h2>
