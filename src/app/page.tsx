...
import { setUser } from "@/lib/features/slices/userSlice";
    ...
    <div className="relative">
      ...
      <div className="xl:px-[124px] md:px-[60px] mobile:px-[30px] mt-[100px]">
        <div className="text-center">
          <h1 className="xl:text-4xl text-[2rem] font-semibold text-[#05264E]">
            Browse by category
          </h1>
          <p className="text-[#6c757d] mt-[10px] mb-[35px] text-sm xl:text-base">
        ...
        <div className="text-[#05264E] w-full bg-white pl-[90px] pr-[190px] py-[25px] flex mt-[100px] border border-[#E0E6F7] rounded-[4px] justify-between">
          <div>
            ...
            <p className={`${merriweather.className} text-[27px] mt-[10px] max-w-[600px]`}>
