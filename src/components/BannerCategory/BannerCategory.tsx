...
const BannerCategory: React.FC<BannerCategoryProps> = ({
  ...
  return (
    <div className="bg-bannerBg bg-center flex flex-col justify-center items-center p-[40px] rounded-xl mt-[100px]">
      <h2 className="mobile:text-[22px] md:text-[28px] text-[#05264E] font-[700] z-10">
      ...
      <div className="mt-[40px]">
        <div className="relative md:w-[580px] bg-white py-[12px] px-[16px] flex gap-4 items-center rounded shadow-custom">
          <div className="flex-1 relative">
            <div className="flex mobile:flex-col md:flex-row items-center gap-[15px] text-[#747474]">
              <FaBriefcase className="text-[40px] mobile:hidden md:block" />
              <div className="w-full mobile:flex items-center md:block">
                <FaBriefcase className="text-[18px] md:hidden mobile:block" />
                <select
                  id="category"
              ...
              <FaSearchLocation className="text-[40px] mobile:hidden md:block" />
             <div className="w-full mobile:flex items-center md:block">
                <FaSearchLocation className="text-[18px] md:hidden mobile:block" />
                <select
                    id="city"
