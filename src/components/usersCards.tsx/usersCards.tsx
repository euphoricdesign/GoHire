...
const UsersCards = ({ users }: { users: IUser[] }) => {
  ...
  return (
    <div className="flex flex-wrap ">
      <div className="mobile:w-full flex justify-center items-center flex-wrap z-30 gap-[20px]">
        {users.map((user) => (
          <div
            key={user.id}
            className="mobile:w-full hover:scale-95 transition-all duration-300 relative"
