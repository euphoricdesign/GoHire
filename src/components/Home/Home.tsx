      ...
      <div className="md:min-h-screen mobile:px-[30px] xl:px-[124px] md:px-[60px] dark:bg-black">
        <div className="md:flex items-center justify-between">
          <div className="flex flex-col gap-14 xl:mt-[247px] md:mt-[170px] mobile:mt-[200px]">
            <h1
              className="xl:text-6xl md:text-[45px] mobile:text-4xl font-bold text-[#05264E] md:w-[500px] dark:text-slate-200"
            ...
            <p className="text-[#05264E] font-normal text-[1.3rem] xl:text-2xl dark:text-slate-200">
              25.478 Offers Worldwide
            </p>
            <SearchBar />
            <p className="text-[#6c757d] text-sm mt-10">
