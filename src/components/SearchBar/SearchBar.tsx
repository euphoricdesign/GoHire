      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1">
          <p className="font-medium text-sm">
            <a href={`/jobs/${job.id}`} className="hover:underline cursor-pointer">
              {job.title}
            </a>
          </p>
          <p className="line-clamp-2 text-xs text-gray-700">{job.description}</p>
          <p className="line-clamp-2 text-xs text-gray-700 mb-1">{job.date}</p>
