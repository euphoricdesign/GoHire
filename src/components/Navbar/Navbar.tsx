    ...
    <header className={`header py-4 px-[124px] ${scrollPosition > 0 ? "scrolled" : ""}`}>
      ...
      <div className="flex items-center gap-3 text-sm">
        <div className="hidden md:flex md:items-center">
          <a className={`${scrollPosition > 0 ? "text-gray-600" : "text-white"}`}>Sign in</a>{" "}
          <div
            className={`w-px h-4 ${
              scrollPosition > 0 ? "bg-gray-600" : "bg-white"
            } mx-1.5`}></div>{" "}
          <a className={`${scrollPosition > 0 ? "text-gray-600" : "text-white"}`}>Dashboard</a>
        </div>
